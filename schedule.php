...
<html>
<title>Scuba School Course Registration</title>
...
<p>In order to register for a class, type in the Course ID below.</p>
<p>You can find the Course ID for the class you wish to take <a href="list.php?<?php echo SID ?>">Here</a></p>
...
<?php } else { ?>
<p>You are not logged in. Please <a href="login.php">Log In</a> to your user account before registering for a course.</br>
